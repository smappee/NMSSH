...
# Simulator slice.
xcodebuild archive -project "$PROJECT_IOS" -scheme 'NMSSH' -configuration Release -destination 'generic/platform=iOS Simulator' -archivePath "$SIMULATOR_ARCHIVE" SKIP_INSTALL=NO EXCLUDED_ARCHS=arm64
